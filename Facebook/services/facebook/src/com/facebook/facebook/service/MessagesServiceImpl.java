 ...
 * @see Messages
 */
@Service("facebook.MessagesService")
@Validated
@EntityService(entityClass = Messages.class, serviceId = "facebook")
public class MessagesServiceImpl implements MessagesService {
    ...
    @Autowired
    @Qualifier("facebook.MessagesDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service facebook for table Messages to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service facebook for table Messages to {} format", options.getExportType());

...
import com.facebook.facebook.service.EventsService;
...
public class EventsController {
    ...
    @ApiOperation(value = "Partially updates the Events instance associated with the given id.")
    @PatchMapping(value = "/{id:.+}")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Events patchEvents(@PathVariable("id") Integer id, @RequestBody @MapTo(Events.class) Map<String, Object> eventsPatch) {
        LOGGER.debug("Partially updating Events with id: {}" , id);

        Events events = eventsService.partialUpdate(id, eventsPatch);
        LOGGER.debug("Events details after partial update: {}" , events);

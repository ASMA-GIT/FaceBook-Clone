...
/**
 * Specifies methods used to obtain and modify NotifyType related information
 * which is stored in the database.
 */
@Repository("facebook.NotifyTypeDao")
public class NotifyTypeDao extends WMGenericDaoImpl<NotifyType, Integer> {

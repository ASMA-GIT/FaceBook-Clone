...
/**
 * Specifies methods used to obtain and modify Chat related information
 * which is stored in the database.
 */
@Repository("facebook.ChatDao")
public class ChatDao extends WMGenericDaoImpl<Chat, Integer> {

...
/**
 * Specifies methods used to obtain and modify LikedPost related information
 * which is stored in the database.
 */
@Repository("facebook.LikedPostDao")
public class LikedPostDao extends WMGenericDaoImpl<LikedPost, Integer> {

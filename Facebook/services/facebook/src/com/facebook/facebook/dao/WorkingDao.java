...
/**
 * Specifies methods used to obtain and modify Working related information
 * which is stored in the database.
 */
@Repository("facebook.WorkingDao")
public class WorkingDao extends WMGenericDaoImpl<Working, Integer> {

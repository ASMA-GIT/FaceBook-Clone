...
/**
 * Specifies methods used to obtain and modify BlockedUsers related information
 * which is stored in the database.
 */
@Repository("facebook.BlockedUsersDao")
public class BlockedUsersDao extends WMGenericDaoImpl<BlockedUsers, Integer> {

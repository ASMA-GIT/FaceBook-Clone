...
/**
 * Specifies methods used to obtain and modify Family related information
 * which is stored in the database.
 */
@Repository("facebook.FamilyDao")
public class FamilyDao extends WMGenericDaoImpl<Family, Integer> {

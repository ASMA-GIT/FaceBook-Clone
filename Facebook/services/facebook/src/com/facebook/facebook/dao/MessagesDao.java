...
/**
 * Specifies methods used to obtain and modify Messages related information
 * which is stored in the database.
 */
@Repository("facebook.MessagesDao")
public class MessagesDao extends WMGenericDaoImpl<Messages, Integer> {

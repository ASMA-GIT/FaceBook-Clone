...
/**
 * Specifies methods used to obtain and modify Feedback related information
 * which is stored in the database.
 */
@Repository("facebook.FeedbackDao")
public class FeedbackDao extends WMGenericDaoImpl<Feedback, Integer> {

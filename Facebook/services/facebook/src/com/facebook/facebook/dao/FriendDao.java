...
/**
 * Specifies methods used to obtain and modify Friend related information
 * which is stored in the database.
 */
@Repository("facebook.FriendDao")
public class FriendDao extends WMGenericDaoImpl<Friend, Integer> {

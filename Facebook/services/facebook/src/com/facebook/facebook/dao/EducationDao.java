...
/**
 * Specifies methods used to obtain and modify Education related information
 * which is stored in the database.
 */
@Repository("facebook.EducationDao")
public class EducationDao extends WMGenericDaoImpl<Education, Integer> {

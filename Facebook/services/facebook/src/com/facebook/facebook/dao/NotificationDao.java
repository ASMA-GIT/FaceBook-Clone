...
/**
 * Specifies methods used to obtain and modify Notification related information
 * which is stored in the database.
 */
@Repository("facebook.NotificationDao")
public class NotificationDao extends WMGenericDaoImpl<Notification, Integer> {

...
/**
 * Specifies methods used to obtain and modify Relation related information
 * which is stored in the database.
 */
@Repository("facebook.RelationDao")
public class RelationDao extends WMGenericDaoImpl<Relation, Integer> {

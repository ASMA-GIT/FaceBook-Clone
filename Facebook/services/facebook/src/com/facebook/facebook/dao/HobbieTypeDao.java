...
/**
 * Specifies methods used to obtain and modify HobbieType related information
 * which is stored in the database.
 */
@Repository("facebook.HobbieTypeDao")
public class HobbieTypeDao extends WMGenericDaoImpl<HobbieType, Integer> {

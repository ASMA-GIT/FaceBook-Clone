...
/**
 * Specifies methods used to obtain and modify SavedPost related information
 * which is stored in the database.
 */
@Repository("facebook.SavedPostDao")
public class SavedPostDao extends WMGenericDaoImpl<SavedPost, Integer> {

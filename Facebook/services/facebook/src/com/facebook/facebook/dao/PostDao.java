...
/**
 * Specifies methods used to obtain and modify Post related information
 * which is stored in the database.
 */
@Repository("facebook.PostDao")
public class PostDao extends WMGenericDaoImpl<Post, Integer> {

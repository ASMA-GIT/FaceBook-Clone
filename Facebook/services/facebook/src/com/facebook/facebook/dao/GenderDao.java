...
/**
 * Specifies methods used to obtain and modify Gender related information
 * which is stored in the database.
 */
@Repository("facebook.GenderDao")
public class GenderDao extends WMGenericDaoImpl<Gender, Integer> {

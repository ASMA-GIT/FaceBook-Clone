...
/**
 * Specifies methods used to obtain and modify PostType related information
 * which is stored in the database.
 */
@Repository("facebook.PostTypeDao")
public class PostTypeDao extends WMGenericDaoImpl<PostType, Integer> {

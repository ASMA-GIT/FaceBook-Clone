...
/**
 * Specifies methods used to obtain and modify Hobbies related information
 * which is stored in the database.
 */
@Repository("facebook.HobbiesDao")
public class HobbiesDao extends WMGenericDaoImpl<Hobbies, Integer> {

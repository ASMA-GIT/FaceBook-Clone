...
/**
 * Specifies methods used to obtain and modify Comment related information
 * which is stored in the database.
 */
@Repository("facebook.CommentDao")
public class CommentDao extends WMGenericDaoImpl<Comment, Integer> {

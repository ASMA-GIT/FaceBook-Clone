...
/**
 * Specifies methods used to obtain and modify PlaceType related information
 * which is stored in the database.
 */
@Repository("facebook.PlaceTypeDao")
public class PlaceTypeDao extends WMGenericDaoImpl<PlaceType, Integer> {

...
/**
 * Specifies methods used to obtain and modify PlacesLived related information
 * which is stored in the database.
 */
@Repository("facebook.PlacesLivedDao")
public class PlacesLivedDao extends WMGenericDaoImpl<PlacesLived, Integer> {
